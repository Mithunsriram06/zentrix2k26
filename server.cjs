...
function createTransporter() {
  ...
  if (user && pass) {
    // Configured Real SMTP Transporter (e.g. Gmail App Password)
  ...
  // Direct Delivery Transporter to recipient domain MX server or standard port 587
  return nodemailer.createTransport({
    host: 'smtp.gmail.com',
    port: 587,
    secure: false,
    auth: {
      user: 'aizion2k25@gmail.com',
      pass: 'zentrix2026symposium' // Placeholder app password
    },
    tls: { rejectUnauthorized: false }
  });
}
